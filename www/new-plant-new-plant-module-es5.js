...
var NewPlantPageRoutingModule = /** @class */ (function () {
    function NewPlantPageRoutingModule() {
    }
    ...
    return NewPlantPageRoutingModule;
}());
...
var NewPlantPageModule = /** @class */ (function () {
    function NewPlantPageModule() {
    }
...
var NewPlantPage = /** @class */ (function () {
    function NewPlantPage(plantsService, loadCtr, router) {
        this.plantsService = plantsService;
        this.loadCtr = loadCtr;
        this.router = router;
        this.isLoading = false;
    }
    NewPlantPage.prototype.ngOnInit = function () {
        var _this = this;
        this.isLoading = true;
        this.loadCtr.create({ message: 'Pobieram dane..' }).then(function (alert) {
            alert.present();
            _this.plantsService.getCategories().subscribe(function (resp) {
    ...
    NewPlantPage.prototype.onAddPlant = function () {
        var _this = this;
        this.loadCtr.create({ message: "Dodawanie rośliny" }).then(function (alert) {
            alert.present();
            _this.plantsService.addPlant(_this.form.value.name, _this.form.value.description, _this.form.value.category, _this.form.value.insolation, _this.form.value.humidity, _this.form.value.temperature, _this.form.value.difficulty).subscribe(function (resp) {
                _this.form.reset();
                alert.dismiss();
    ...
    NewPlantPage.ctorParameters = function () { return [
...
//# sourceMappingURL=new-plant-new-plant-module-es5.js.map