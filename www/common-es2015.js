...
let PlantDetailsPageRoutingModule = class PlantDetailsPageRoutingModule {
};
...
let PlantDetailsPageModule = class PlantDetailsPageModule {
};
...
let PlantDetailsPage = class PlantDetailsPage {
    constructor(route, router, plantService, loadCtr) {
        this.route = route;
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.loadCtr.create({ message: 'Pobieram dane..' }).then(alert => {
            ...
            this.route.paramMap.subscribe(paramMap => {
                ...
                this.plantSubscription = this.plantService.getPlant(this.plantId).subscribe(resp => {
...
PlantDetailsPage.ctorParameters = () => [
...
class Plant {
    constructor(id, name, img, description, category_id, insolation, humidity, temperature, difficulty, category_name) {
        this.id = id;
        this.name = name;
        this.img = img;
...
let PlantsService = class PlantsService {
    ...
    getPlants() {
        return this.http.get('http://projekt.dev.cymer.pl/api/getplants')
            ...
            return plants;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(plants => {
            this._plants.next(plants);
        }));
    }
    getPlant(id) {
        return this.http.get(`http://projekt.dev.cymer.pl/api/getsingleplant?plantId=${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => {
            return {
    ...
    updatePlant(id, name, category_id) {
        console.log("Update");
    ...
    addPlant(name, description, category_id, insolation, humidity, temperature, difficulty) {
