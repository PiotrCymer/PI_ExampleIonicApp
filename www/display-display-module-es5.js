...
var routes = [
    ...
    {
        path: 'plant-details',
        loadChildren: function () { return __webpack_require__.e(/*! import() | plant-details-plant-details-module */ "common").then(__webpack_require__.bind(null, /*! ./plant-details/plant-details.module */ "./src/app/plants/display/plant-details/plant-details.module.ts")).then(function (m) { return m.PlantDetailsPageModule; }); }
    }
];
var DisplayPageRoutingModule = /** @class */ (function () {
    function DisplayPageRoutingModule() {
    }
...
var DisplayPageModule = /** @class */ (function () {
...
var DisplayPage = /** @class */ (function () {
    function DisplayPage(plantsService, router) {
        this.plantsService = plantsService;
        this.router = router;
    }
    DisplayPage.prototype.ngOnInit = function () {
        var _this = this;
        this.plantsSubscription = this.plantsService.getPlants().subscribe(function (resp) {
            _this.plants = resp;
        });
    };
    DisplayPage.prototype.onEdit = function (plantId, slidingItem) {
        slidingItem.close();
        this.router.navigate(['/', 'plants', 'tabs', 'display', 'edit', plantId]);
    };
    DisplayPage.prototype.doRefresh = function (event) {
        var _this = this;
        this.plantsService.getPlants().subscribe(function (resp) {
            _this.plants = resp;
        });
        event.target.complete();
    };
    DisplayPage.prototype.t = function ($event) {
        alert($event);
    };
    DisplayPage.prototype.ngOnDestroy = function () {
        if (this.plantsSubscription)
            this.plantsSubscription.unsubscribe();
    };
    DisplayPage.ctorParameters = function () { return [
...
var SinglePlantComponent = /** @class */ (function () {
    function SinglePlantComponent(router) {
        this.router = router;
        this.titleClick = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    SinglePlantComponent.prototype.ngOnInit = function () { };
    SinglePlantComponent.prototype.showDetails = function (plantId) {
        console.log("Details" + plantId);
        this.router.navigate(['/', 'plants', 'tabs', 'display', plantId]);
    };
    SinglePlantComponent.prototype.onTitleClick = function () {
        this.titleClick.emit(this.plant.name);
    };
    SinglePlantComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var RepairImgPipe = /** @class */ (function () {
    function RepairImgPipe() {
    }
    RepairImgPipe.prototype.transform = function (value) {
        var args = [];
